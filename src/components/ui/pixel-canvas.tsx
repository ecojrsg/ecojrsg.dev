...
class PixelCanvasElement extends (typeof HTMLElement !== "undefined" ? HTMLElement : Object as any) {
  ...
  connectedCallback() {
    ...
    requestAnimationFrame(() => {
      ...
      ro.observe(this as unknown as Element)
    ...
    React.useEffect(() => {
      ...
      if (typeof window !== "undefined") {
        if (!customElements.get("pixel-canvas")) {
          customElements.define("pixel-canvas", PixelCanvasElement as unknown as CustomElementConstructor)
        }
      }
    }, [])

    const PixelCanvasEl = "pixel-canvas" as any;
